...
public class AuthController(IConfiguration config) : ControllerBase
{
    ...
    private string _username = config["WebUsername"] ??
                               throw new InvalidOperationException(
                                   "WebUsername er ikke konfigureret. Sæt env var 'WebUsername' eller tilføj 'WebUsername' i appsettings.");

    private string _password = config["WebPassword"] ??
                               throw new InvalidOperationException(
                                   "WebPassword er ikke konfigureret. Sæt env var 'WebPassword' eller tilføj 'WebPassword' i appsettings.");
